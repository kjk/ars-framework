...
void HmStyleList::drawItemBackground(Graphics& graphics, Rect& bounds, uint_t item, bool selected)
{
...
void HmStyleList::drawScrollBar(Graphics& graphics, const Rect& bounds)
{
    ...
    long visibleItems=this->height()/itemHeight();
    ...
    graphics.erase(Rect(traktorX, traktorY, traktorWidth, traktorHeight));
